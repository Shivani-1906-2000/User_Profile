    ...
    <div class="row">
        ...
        <form method="POST" class="form-horizontal" id="form_test">
           <div class="row form-group input_group">
               ...
               <div class="col-sm-10">
                   <input type="password" name="password_reset" class="form-control" id="password_reset"> <span id="error_password"></span>
               </div>
           </div>
           ...
           <div class="row form-group input_group">
               ...
               <div class="col-sm-10">
                   <input type="password" name="c_password_reset" class="form-control" id="c_password_reset"> <span id="error_password"></span>
               </div>
           </div>
           <div class="row form-group input_group" style="margin:0px 40px 20px 40px; padding-left:20%;">
               <div class="col-xs-10">
                   <input type="submit" name="reset" class="form-control" id="reset" value="Reset Password">
               </div>
           </div>
        </form>
    </div>
