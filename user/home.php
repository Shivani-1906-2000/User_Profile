...
<?php include("../SCRIPT/view_profile.php") ?>
<?php include("../SCRIPT/user_profile.php") ?>
...
function allUsers(){
    ...
    $select_query = mysqli_query($conn, "SELECT * FROM profile WHERE user_id != {$_SESSION['id']}");
            ...
            //Similarly if the user has not data in the profile table, the user should see only the first name, last name, an icon for image and a button to take the user to the complete profile page
                if($count <= 0){
                    echo "<div class='col-sm-10 col-md-10 col-lg-10'>
                                ...
                                <a href='../users/complete_profile.php' class='btn btn-block btn-primary'>Complete Your Profile</a>
                            </div>";
                }else{
